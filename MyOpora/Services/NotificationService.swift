...
final class NotificationService: ObservableObject {
    ...
    private var humaneNotifications: [PokeNotification] {
        [
            ...
            PokeNotification(id: "opora.poke.evening", hour: 16, minute: 50, title: "Домой без исчезновения", body: "Через 10 минут выход. Назови состояние заранее. Семья — не плата за успех."),
    ...
    private var ruthlessNotifications: [PokeNotification] {
        [
            ...
            PokeNotification(id: "opora.poke.evening", hour: 16, minute: 50, title: "Домой, объект", body: "Через 10 минут выход. Статус жене. Не исчезать. Семья не должна угадывать, какой там пожар в проде."),
